...
module.exports = {
  ...
  mongodb_uri: 'mongodb+srv://xnuxer-bot:xnuxer_inty@cluster0.1wvvsli.mongodb.net/?retryWrites=true&w=majority', // Register here: https://mongodb.com/#sign-up
  api: {
    url: 'https://daniapi.biz.id',
    key: 'sk-ztsv288sftck25df0' // Register here: https://daniapi.biz.id/#sign-up
  },
  bot: {
    name: 'Xnuxer',
  ...
  watermark: {
    sticker: {
      package_name: 'Owner By',
      author_name: 'Fahrudin'
    }
  },
  react: {
    process: '⏳',
